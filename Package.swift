...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "ITGPlayerViewControllerSwiftUI", dependencies: ["ITGPlayerViewController"], path: "Sources/SupportingFiles/PlayerControllerAndAdapters/", sources: ["ITGPlayerViewControllerSwiftUI.swift"]),
        .target(name: "ITGOverlayViewSwiftUI", path: "Sources/SupportingFiles/PlayerControllerAndAdapters/", sources: ["ITGOverlayViewSwiftUI.swift"]),
    ]
)
