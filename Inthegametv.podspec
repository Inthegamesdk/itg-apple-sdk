Pod::Spec.new do |s|
    ...
    s.requires_arc = true
    s.ios.vendored_frameworks = 'Sources/InthegametviOS.xcframework', 'Sources/Storket.xcframework'
    s.tvos.vendored_frameworks = 'Sources/Inthegametv.xcframework', 'Sources/Storket.xcframework'
